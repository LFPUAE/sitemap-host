...
class SupportFormWidget extends StatefulWidget {
  ...
  static String routeName = 'SupportForm';
  static String routePath = '/supportForm';
                            ...
                            child: Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  await launchUrl(Uri(
                                      scheme: 'mailto',
                                      path: 'support@lookforproperty.ae',
                                      query: {
                                        'subject': 'Look For Property Support',
                                      }
                                          .entries
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            ...
                            if (selectedMedia != null &&
                              ...
                              safeSetState(() =>
                                  _model.isDataUploading_uploadDataPlk = true);
                              ...
                              try {
                                ...
                                _model.isDataUploading_uploadDataPlk = false;
                              }
                              if (selectedUploadedFiles.length ==
                                  selectedMedia.length) {
                                safeSetState(() {
                                  _model.uploadedLocalFile_uploadDataPlk =
                          ...
                          onPressed: () async {
                            await SupportTicketRecord.collection
                                ...
                                .set(createSupportTicketRecordData(
                                  ...
                                  media: _model
                                      .uploadedLocalFile_uploadDataPlk.blurHash,
                                ));
                          },
                          text: 'Submit Ticket',
                          icon: Icon(
